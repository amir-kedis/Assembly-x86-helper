...
DATA SEGMENT USE16
     ...
     ; MESSAGES
     Mode_Str      DB  'SVGA Mode 640x480x256', 0Dh, 0Ah, '$'
     Msg           DB  'Press any key to exit', 0Dh, 0Ah, '$'

     BG_COLOR      EQU 0h                                         ; BLACK
...
CODE SEGMENT USE16
     ...
     ; Print Message
                ...
                MOV    DX, OFFSET Mode_Str     ; Offset of string to print
     ...
     ; Set Cursor Position At center
                ...
                MOV    AH, 09h                 ; Function 09h = Print string
                MOV    DX, OFFSET Msg          ; Offset of string to print
                INT    21h                     ; Call DOS interrupt
